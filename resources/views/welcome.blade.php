...
<head>
  ...
  <link href="{{asset ('arsha/assets/vendor/remixicon/remixicon.cs')}}s" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Arsha Resmi Zulfarik</a></h1>
    ...
    <section id="clients" class="clients section-bg">
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="{{asset ('arshsa/assets/img/clients/client-2.png')}}" class="img-fluid" alt="">
          </div>
